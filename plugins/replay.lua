...
return  " عذراً 🌝".. ":{" ..msg.from.first_name.. "}:".."\n".."\n".." 🗯قائمة الردود العامه فارغة بالفعل 👮🏻‍♀️ "
else
...
local i = 1
local message = '💢 ردود العامه في البوت  👮🏻‍♀️\n\n'
for k,v in pairs(data['replay_all']) do
message = message ..i..' - ('..k..') \n'
i = i + 1
end
...
tdcli.sendMessage(msg.to.id, 0, 1, " 🚸┇ TH3BOSS  \n\n 🚸┇ @TH3BOSS\n🚸┇ @lBOSSl", 1, 'html')
...
"سويت هواي شغلات سخيفه بحياتي بس محمدي مصحت على واحد وكلتله انجب 😑",
"مشغول ويا ضلعتي  ☺️",
"مازا تريد منه 😌🍃",
...
"ايامي وياها👫اتمنا انساها😔متندم اني حيل😞يم غيري هيه💃تضحك😂عليه😔مقهور انام الليل😢كاعد امسح بل رسائل✉️وجان اشوف كل رسايلها📩وبجيت هوايه😭شفت احبك😍واني من دونك اموت😱وشفت واحد 🚶صار هسه وياية👬اني رايدها محمد محمد تعرفني كل زين🙈 وماردت لا مصلحة ولاغايه😕والله مافد يوم بايسها💋خاف تطلع🗣البوسه💋وتجيها حجايه😔️",
...
if string.match(ww, 'محمد')  or  string.match(ww, 'حموش') or  string.match(ww, 'حمودي') or  string.match(ww, 'حمود')  or string.match(ww, 'حموشي') then
return true
else
return false
end
