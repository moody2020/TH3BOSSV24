...
🚸║م المطور ⇜⇜ للمطور فقط 
⚜️╣═════════
👨‍║ اضغط لتحدث مع المطور 👇🏿 ]]..check_markdown(sudouser) 
...
if not is_mod(msg) then return "🚸║ للاداريين فقط 🎖" end
local text = [[
👨‍✈️║اوامر التنزيل والرفع بـ البوت👇🏿
⚜️╣════════
🚸║رفع ادمن ⇜ لرفع ادمن 
🚸║تنزيل ادمن ⇜ لتنزيل ادمن
🚸║رفع عضو مميز ⇜ لرفع مميز 
...
🚸║تفعيل║ تعطيل ⇠ الايدي
⚜️╣═══════
👨‍✈️║ اضغط لتحدث مع المطور 👇🏿 ]]..check_markdown(sudouser) 
return tdcli.sendMessage(msg.to.id, 1, 1, text, 1, 'md')
...
⚜️╣═════════
👨‍✈️║  اضغط للتحدث مع المطور ]]..check_markdown(sudouser) 
return tdcli.sendMessage(msg.to.id, 1, 1, text, 1, 'md')
